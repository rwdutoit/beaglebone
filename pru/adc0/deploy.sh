...
echo "copying scope0.out  to  /lib/firmware/am335x-pru0-fw"
cp /home/debian/beaglebone/pru/scope0/gen/scope0.out /lib/firmware/am335x-pru0-fw

echo "copying  PRU_Halt.out   to  /lib/firmware/am335x-pru1-fw"
cp /home/debian/beaglebone/pru/scope0/gen/PRU_Halt.out /lib/firmware/am335x-pru1-fw
