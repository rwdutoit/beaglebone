	...
	while (keepRunning) 
	{
		...
		if (result > 0)
			...
			printf("%c[H%c[J Reading:%d \n\r Movement:\n\r"
				...
				"%c[%dm Kitchen: 	%d %c[40m\n\r"
				"%c[%dm Panic: 	%d %c[40m\n\r"
				"%c[%dm Distance: 	%d mm %c[40m",//  %c[2K %s %c[1A",
				27,27,count,
				27,motion[0],readBuf[0]-48,27,
				27,motion[1],readBuf[1]-48,27,
				27,motion[2],readBuf[2]-48,27,
				27,motion[3],readBuf[3]-48,27,
				27,motion[4],readBuf[4]-48,27,
				27,motion[5],readBuf[5]-48,27,
				27,motion[6],readBuf[6]-48,27,
				27,motion[7],readBuf[7]-48,27,
